...
public class UserspaceController {
   ...
   private BlogService blogService;
    ...
    public ModelAndView createBlog(@PathVariable(value = "username") String username,Model model) {
        User user = (User)userDetailsService.loadUserByUsername(username);
    ...
    public ModelAndView editBlog(@PathVariable(value = "username") String username,@PathVariable(value = "id") Long id,Model model){
          // 获取用户分类列表
          User user = (User)userDetailsService.loadUserByUsername(username);
          List<Catalog> catalogs = catalogService.listCatalogs(user);
          model.addAttribute("catalogs",catalogs);
